This package is internally used by [@react-ssr-withLess/express](https://npm.im/@react-ssr-withLess/express) and [@react-ssr-withLess/nestjs-express](https://npm.im/@react-ssr-withLess/nestjs-express).
